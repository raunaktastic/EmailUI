 ...
 * Features a deep purple header bar with the logo, clean white body,
 * and a prominent, high-contrast hero element for the verification code.
 *
 * Template Variables:
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .otp-box {
      ...
      letter-spacing: 10px;
      color: #5B2EF7;
      box-shadow: 0 4px 12px rgba(91, 46, 247, 0.06);
    }
