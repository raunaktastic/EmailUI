/**
 * Espotz — Clan Deactivated Email Template
 *
...
export const clanDeactivated = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Clan Deactivated</title>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .clan-avatar {
      ...
      height: 64px;
      border-radius: 8px;
      border: 2px solid #ef4444; /* Red border for deactivated */
      object-fit: cover;
    }
