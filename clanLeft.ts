/**
 * Espotz — Clan Left Email Template
 *
...
export const clanLeft = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Left Clan</title>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .clan-avatar {
      ...
      height: 64px;
      border-radius: 8px;
      border: 2px solid #ea580c; /* Orange border for leaving */
      object-fit: cover;
    }
