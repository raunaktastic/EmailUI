 ...
 *
 * Theme: Celebratory Transactional Layout (Consistent with Clan POC)
 * Features a deep purple header bar with the logo, a success/celebration badge,
 * a premium coin highlight box for the donation amount, and a call-to-action button.
 *
 * Template Variables:
 *  {{logoUrl}}        — Full URL to the Espotz logo image
 *  {{name}}           — The user's name
 *  {{donationAmount}} — The donation amount in EC (e.g. 50.00)
  ...
  <div class="email-wrap">
    ...
    <div class="email-body">
      ...
      <div class="donation-highlight">
        <div class="donation-label">Amount Contributed</div>
      ...
      <div class="message" style="color: #2d0745; font-weight: 600;">
